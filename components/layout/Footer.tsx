...
import { NAP, SOCIAL_LINKS, WHATSAPP_CTA } from '@/lib/constants'
    ...
    <footer className="bg-brand-navy text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" aria-label="Artgon MEDIA — Accueil">
              <Image
                src="/logo-artgon.jpg"
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-400">
              Agence web & digitale à Nador, Maroc. Création de sites web, applications mobiles, SEO et marketing digital.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Artgon MEDIA sur Facebook"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Artgon MEDIA sur Instagram"
                className="text-gray-400 transition-colors hover:text-white"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Artgon MEDIA sur LinkedIn"
                className="text-gray-400 transition-colors hover:text-white"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-white">Agence</h3>
            <ul className="mt-4 space-y-2">
              {[
          ...
          <div>
            ...
            <address className="mt-4 space-y-3 not-italic text-sm text-gray-400">
              <p>{NAP.streetAddress}</p>
              <p>{NAP.postalCode} {NAP.addressLocality}, {NAP.addressRegion}</p>
              <p>Maroc</p>
              <a
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-xs text-gray-500">
              © {currentYear} {NAP.name} — {NAP.rc} · {NAP.ice}
            </p>
